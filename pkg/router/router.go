...
func HandleRequest() {
	...
	v1 := router.Group("/api/v1")
	{
		...
		v1.OPTIONS("/products/:id", controller.OptionMessage)
		...
		v1.OPTIONS("/areas/:id", controller.OptionMessage)
		...
		v1.OPTIONS("/features/:id", controller.OptionMessage)

		v1.POST("/tests", controller.AddTest)
		v1.DELETE("/tests/:id", controller.DeleteTest)
		v1.OPTIONS("/tests/:id", controller.OptionMessage)
		...
		v1.OPTIONS("/expl-tests/:id", controller.OptionMessage)
